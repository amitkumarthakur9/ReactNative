...
import { searchFundhouse } from "../../api/services/endpoints/exploreEndpoints";
...
export default Switchsearch = ({ navigation }) => {
  ...
  const handleSearch = (text) => {
    const data = {
      ...
      type: "",
      term: text,
      fundhouse: holdingDatas.mutualFund.fundHouse.id,
    };
    setSearch(text);
    if (text.length >= 3) {
      ...
      <View style={styles.trendingSchemesContainer}>
        ...
        <View style={styles.trendCardContainer}>
          ...
          <View style={styles.flexRow}>
            ...
            >
              <Text style={styles.invest}>SELECT MUTUALFUND</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
